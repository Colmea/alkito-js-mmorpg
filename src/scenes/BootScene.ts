...
export default class BootScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image(
      "tileset_grass",
      "assets/map/tileset/tileset_grass_extruded.png"
    );
    this.load.tilemapTiledJSON("map", "assets/map/world.json");

    // player
    this.load.spritesheet("tileset", "assets/map/tileset/tileset.png", {
      frameWidth: 32,
      frameHeight: 32,
    });
    ...
    this.load.spritesheet("other-player", "assets/other-player-sprite.png", {
      frameWidth: 32,
      frameHeight: 32,
    });
    // objects
    ...
    this.load.image(
      ...
      "assets/ui/menu-button-active.png"
    );
    ...
    this.load.spritesheet("ui.bars", "assets/ui/bars.png", {
      frameWidth: 10,
      frameHeight: 14,
    });
    ...
    // Items
    this.load.spritesheet("items/plants", "assets/items/plants_items.png", {
      frameWidth: 32,
      frameHeight: 32,
    });
    ...
    // Resources
    this.load.spritesheet("plants", "assets/items/plants.png", {
      frameWidth: 32,
      frameHeight: 64,
    });
    this.load.spritesheet(
      "resources.woodcutting",
      "assets/items/resources-tree.png",
